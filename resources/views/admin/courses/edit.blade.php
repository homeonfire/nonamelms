            ...
            <div class="space-y-6">
                ...
                @if ($leadPayEnabled)
                    <div>
                        ...
                        <input type="text" name="leadpay_product_id" id="leadpay_product_id" value="{{ old('leadpay_product_id', $course->leadpay_product_id) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                    </div>
                @endif
            </div>
