<x-admin-layout>
    <h1 class="text-3xl font-bold text-white mb-6">Редактировать пост</h1>
        ...
        <div class="bg-gray-800 border border-gray-700 shadow-md rounded-lg p-6">
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title" class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg block w-full p-2.5" value="{{ old('title', $post->title) }}" required>
                </div>

                {{-- Краткое содержание --}}
                <div>
                    <label for="excerpt" class="block mb-2 text-sm font-medium text-gray-300">Краткое содержание (для превью)</label>
                    <textarea name="excerpt" id="excerpt" rows="3" class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg block w-full p-2.5">{{ old('excerpt', $post->excerpt) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <div id="editorjs"
                         ...
                         class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg block w-full p-2.5 min-h-[300px]"></div>
